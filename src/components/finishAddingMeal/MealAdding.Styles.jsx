...
export const MealAddingContainer = styled(ModalContainer)`
...
export const AddMealButtonContainer = styled.div`
align-self: flex-end;
...
export const ServingCalorieCount = styled.div`
...
export const CaloriesTextContainer = styled.div`
display: flex;
  justify-content: flex-start;
  gap: 10px;
`
